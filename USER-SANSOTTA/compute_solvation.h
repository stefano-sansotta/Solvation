...
ComputeStyle(solvation,ComputeSolvation)

#else

#ifndef LMP_COMPUTE_SOLVATION_H
#define LMP_COMPUTE_SOLVATION_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeSolvation : public Compute {
 public:
  ComputeSolvation(class LAMMPS *, int, char **);
  ~ComputeSolvation();
  void init();
 ...
 private:
  ...
  double **cutsq;
  double e_self,e_correction,cutoff;
